namespace Org.BouncyCastle.Math.EC {
   ...
   public class FpFieldElement: ECFieldElement {
      ...
      public FpFieldElement(BigInteger q, BigInteger x) {
         if (x.CompareTo(q) >= 0) {
            throw new System.ArgumentException("x value too large in field element");
         }
      ...
      private static BigInteger[] fastLucasSequence(
         ...
         // O-FIXME: Debug.Assert(k.TestBit(s));
   ...
   /**
      ...
      representation. Both trinomial (Tpb) and pentanomial (Ppb)
      polynomial basis representations are supported. Gaussian normal
      basis (GNB) representation is not supported.
   */
      ...
      */
      public static void CheckFieldElements(
         ...
         if (!(a is F2mFieldElement) || !(b is F2mFieldElement)) {
            throw new System.ArgumentException("Field elements are not "
      ...
      public override ECFieldElement Sqrt() {
         throw new System.ArithmeticException("Not implemented");
      }

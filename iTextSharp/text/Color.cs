   ...
   */
   public class Color {
      ...
      public Color Brighter() {
         ...
         return new Color(System.Math.Min((int)(r/FACTOR), 255), 
                          System.Math.Min((int)(g/FACTOR), 255),
                          System.Math.Min((int)(b/FACTOR), 255));
      }

      public Color Darker() {
         return new Color(System.Math.Max((int)(color.R * FACTOR), 0), 
                          System.Math.Max((int)(color.G * FACTOR), 0),
                          System.Math.Max((int)(color.B * FACTOR), 0));
      }
